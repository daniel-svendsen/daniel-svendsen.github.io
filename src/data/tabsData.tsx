    ...
    return [
        {
            ...
            content: (
                <div className="p-4 bg-background rounded-md shadow-sm text-xs sm:text-sm space-y-3">
        ...
        },
        {
            ...
            content: (
                <ul className="p-4 bg-background rounded-md shadow-sm space-y-2 text-xs sm:text-sm">
                    {(content.languages.content as Array<{ name: string; level: string }>).map(
                        (item, index) => (
                            <li key={index}>
                                <strong className="text-highlight">{item.name}:</strong>{' '}
                                {item.level}
        ...
        },
        {
            ...
            content: (
                <div className="p-4 bg-background rounded-md shadow-sm space-y-3 text-xs sm:text-sm">
