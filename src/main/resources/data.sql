...
VALUES (1, 'Languages', 'Java', 'Java'),
       ...
       (1, 'Languages', 'SQL', 'SQL'),
       (1, 'Frameworks/Tools', 'Spring Boot', 'Spring Boot'),
       (1, 'Frameworks/Tools', 'React', 'React'),
       (1, 'Frameworks/Tools', 'Vite', 'Vite'),
       (1, 'Frameworks/Tools', 'Gradle', 'Gradle'),
       (1, 'Frameworks/Tools', 'Git', 'Git'),
       (1, 'Frameworks/Tools', 'Docker', 'Docker'),
       (1, 'Frameworks/Tools', 'Jenkins', 'Jenkins'),
       (1, 'Frameworks/Tools', 'Bash', 'Bash'),
       (1, 'Frameworks/Tools', 'IntelliJ', 'IntelliJ'),
       (1, 'Databases', 'SQL Server', 'SQL Server'),
