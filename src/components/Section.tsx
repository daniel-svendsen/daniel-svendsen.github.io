...
const sectionVariantsConfig = cva('relative', {
  variants: {
    ...
    rounded: {
      ...
      '7xl': 'rounded-7xl',
      '8xl': 'rounded-8xl',
      '9xl': 'rounded-[2rem] md:rounded-7xl lg:rounded-9xl',
      '10xl': 'rounded-[2.25rem] md:rounded-8xl lg:rounded-10xl',
      full: 'rounded-full',
    },
    roundedTop: {
      none: '',
      ...
      '7xl': 'rounded-t-7xl',
      '8xl': 'rounded-t-8xl',
      '9xl': 'rounded-t-[2rem] md:rounded-t-7xl lg:rounded-t-9xl',
      '10xl': 'rounded-t-[2.25rem] md:rounded-t-8xl lg:rounded-t-10xl',
      full: 'rounded-t-full',
    },
    roundedBottom: {
      none: '',
      ...
      '7xl': 'rounded-b-7xl',
      '8xl': 'rounded-b-8xl',
      '9xl': 'rounded-b-[2rem] md:rounded-b-7xl lg:rounded-b-9xl',
      '10xl': 'rounded-b-[2.25rem] md:rounded-b-8xl lg:rounded-b-10xl',
      full: 'rounded-b-full',
    },
  },
  defaultVariants: {
