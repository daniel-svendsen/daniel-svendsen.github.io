    ...
    return (
        <>
            <Helmet>
                ...
                <meta
                    name="description"
                    content="Utforska vår prislista för bröllop, porträtt och företagsfotografering. Kontakta oss för mer information!"
                />
                <meta
                    name="keywords"
                ...
                <meta
                    ...
                    content="Utforska våra priser för bröllopsfotografering, porträtt och företagsbilder."
                />
                <meta
                    property="og:image"
