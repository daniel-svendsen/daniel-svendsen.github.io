...
const CV = () => {
    const content = {
        ...
        skills: {
            ...
            content: [
                "Jag är en engagerad och driven fullstackutvecklare med en kombination av teknisk kompetens och ledarskapserfarenhet. " +
                ...
                "Jag brinner för att skapa nytt och lösningar från grunden och att bidra till starka och samarbetsvilliga team.",
