import{x as r,o as e,q as y,L as d}from"./index-BTSoHJWT.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const m=r("Camera",[["path",{d:"M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z",key:"1tc9qg"}],["circle",{cx:"12",cy:"13",r:"3",key:"1vg3eu"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const p=r("Code",[["polyline",{points:"16 18 22 12 16 6",key:"z7tu5w"}],["polyline",{points:"8 6 2 12 8 18",key:"1eg1df"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const f=r("Users",[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["path",{d:"M16 3.13a4 4 0 0 1 0 7.75",key:"1da9ce"}]]);function w({image:a,imageLink:i,title:t,description:x,price:n,buttonText:o,buttonLink:s,onClick:v,icon:l,reverse:c=!1}){return e.jsxs(y.article,{onClick:v,className:`
      ...
      `,whileHover:{scale:1.01},whileTap:{scale:.98},initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0,amount:.1},transition:{type:"spring",stiffness:300},children:[a&&e.jsx("figure",{className:`
            ...
            ${c?"lg:ml-4":"lg:mr-4"}
            mb-4 lg:mb-0
          `,children:i?e.jsx(d,{to:i,"aria-label":`View gallery for ${t}`,children:e.jsx("img",{src:a,alt:t,className:"w-full h-full object-cover transition-transform duration-500 cursor-pointer",loading:"lazy"})}):e.jsx("img",{src:a,alt:t,className:"w-full h-full object-cover transition-transform duration-500",loading:"lazy"})}),e.jsxs("div",{className:`
          flex flex-col items-center justify-center p-4
          w-full lg:w-2/3 text-center
        `,children:[l&&e.jsx(l,{size:24,className:"text-textSecondary mb-2"}),e.jsx("h2",{className:"text-lg font-poiret font-bold tracking-wider mb-2",children:t}),e.jsx("p",{className:"text-sm text-textSecondary whitespace-pre-line font-poiret",children:x}),n&&e.jsx("p",{className:"text-lg font-bold mt-2",children:n}),o&&s&&e.jsx(d,{to:s,className:"mt-4 px-6 py-2 bg-highlight text-white rounded-md shadow transition",children:o})]})]})}const k="/assets/wedding-Se-qk-Wt.jpg",h="/assets/portrait-BuLiEXZv.jpg",b="/assets/company-BrR4d-y-.jpg",u="/assets/webdev-Bfv3hU6p.png",F=[{image:k,title:"Bröllopsfotografering & Bröllopsfilm",description:`Ert bröllop är en unik och kärleksfull dag, och jag hjälper er att fånga alla magiska ögonblick. 
                  ...
                  • SEO-optimering & support → Från 2000 kr/månad`,price:"Från 4500 KR",buttonText:"Kontakt",buttonLink:"/contact",icon:p}];export{w as C,F as h,L as s,u as w};
//# sourceMappingURL=cards-DqDEDZdl.js.map
